...
```
-(NSString *)myMethod:(NSString *)arg1 arg2:(NSString *)arg2 arg3:(NSString *)arg3 arg4:(NSString *)arg4{
    NSString *rs = [NSString stringWithFormat:@"myMethod... %@ %@ %@ %@",arg1,arg2,arg3,arg4];
    NSLog(@"myMethod rs = %@",rs);
    return rs;
}
-(void)test4{
    NSArray *arguments = @[@"1",@"2",@"3",@"4"];
    NSString *result = @"";
//    SEL selector = NSSelectorFromString(@"myMethod:arg2:arg3:arg4:");
    SEL selector = @selector(myMethod:arg2:arg3:arg4:);
    NSMethodSignature *signature = [self methodSignatureForSelector:selector];
    //performSelector最多支持两个参数,使用NSInvocation支持多参数myMethod:arg2:arg3:arg4:
    NSInvocation *invocation = [NSInvocation invocationWithMethodSignature:signature];
    [invocation setSelector:selector];
    [invocation sa_setArgumentsFromArray:arguments];
    [invocation invokeWithTarget:self];
    
    if([signature methodReturnLength] > 0){
        result = [invocation sa_returnValue];
    }
    NSLog(@"test4 result = %@",result);
}
```
